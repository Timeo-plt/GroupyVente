    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
            ...
            <div class="d-flex ms-auto gap-2">
                ...
                <a href="../deconnexion.php" class="btn btn-outline-secondary btn-sm">Se déconnecter</a>
                <a href="parrainage.php" class="btn btn-outline-info btn-sm">Parrainage</a>
            </div>
        </div>
    </nav>
</header>
    ...
    <div class="container my-5">
        ...
        if (isset($_SESSION['participation_success'])) {
            echo '<div class="alert alert-success alert-dismissible fade show" role="alert">
                    ...
                    <a href="factures.php" class="alert-link">Voir mes factures</a>
